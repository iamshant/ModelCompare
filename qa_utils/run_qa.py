...
#                     writer.write(f"{key} = {value}\n")
            name = model_args.model_name_or_path.split('-')[0]
            with open('qna_results_' + name + '.json', 'w', encoding='utf-8') as f:
                json.dump({'qna': {name:results}}, f, ensure_ascii=False, indent=4)
    return results
